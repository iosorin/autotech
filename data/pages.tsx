...
export const tariffs = {
    ...
    plans: [
        { icons: [<Droplets key="0" className="size-5 text-red-500" />], name: "Автомойка", values: { "1m": "4 000", "3m": "11 000", "12m": "40 000" } },
        { icons: [<Droplets key="0" className="size-5 text-red-500" />, <Scissors key="1" className="size-5" />], name: "Автомойка + Шиномонтаж", values: { "1m": "5 000", "3m": "13 750", "12m": "50 000" } },
        { icons: [<Droplets key="0" className="size-5 text-red-500" />, <Car key="2" className="size-5" />], name: "Автомойка + Детейлинг", values: { "1m": "6 000", "3m": "16 500", "12m": "60 000" } },
        { icons: [<Droplets key="0" className="size-5 text-red-500" />, <Car key="2" className="size-5" />, <Scissors key="3" className="size-5" />], name: "Автомойка + Детейлинг + Шиномонтаж", values: { "1m": "7 000", "3m": "19 250", "12m": "70 000" }, highlighted: true },
        { icons: [<Scissors key="0" className="size-5 text-red-500" />], name: "Шиномонтаж", values: { "1m": "2 000", "3m": "5 500", "12m": "20 000" } },
    ],
