...
export const home = {
    ...
    migration: {
        ...
        desc: "Переносим все данные из других наиболее популярных приложений\n за минуту, включая базы клиентов физ.лиц и контрагентов, \nостатки бонусов, средние чеки и количество визитов",
        items: [
