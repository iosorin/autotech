...
export const home = {
    ...
    faq: {
        ...
        items: [
            ...
            {
                question: "Наши работники уже привыкли к интерфейсу другого приложения, они долго будут привыкать к новой программе",
...
export const tariffs = {
    ...
    plans: [
        { icons: [<Droplets key="0" className="size-7 text-white" />], name: "Автомойка", values: { "1m": "4 000", "3m": "11 000", "12m": "40 000" } },
        { icons: [<Droplets key="0" className="size-7 text-white" />, <Scissors key="1" className="size-7 text-white" />], name: "Автомойка + Шиномонтаж", values: { "1m": "5 000", "3m": "13 750", "12m": "50 000" } },
        { icons: [<Droplets key="0" className="size-7 text-white" />, <Car key="2" className="size-7 text-white" />], name: "Автомойка + Детейлинг", values: { "1m": "6 000", "3m": "16 500", "12m": "60 000" } },
        { icons: [<Droplets key="0" className="size-7 text-white" />, <Car key="2" className="size-7 text-white" />, <Scissors key="3" className="size-7 text-white" />], name: "Автомойка + Детейлинг + Шиномонтаж", values: { "1m": "7 000", "3m": "19 250", "12m": "70 000" } },
        { icons: [<Scissors key="0" className="size-7 text-white" />], name: "Шиномонтаж", values: { "1m": "2 000", "3m": "5 500", "12m": "20 000" } },
    ],
