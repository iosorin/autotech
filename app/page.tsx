        ...
        <Block
          ...
          cta={
            <Link
              ...
              className={cn("text-white shadow-sm inline-flex items-center gap-4 rounded-3xl px-5 py-4 text-sm w-fit hover:opacity-90 transition-opacity", p.hero.telegram.className)}
            >
              <svg viewBox="0 0 24 24" fill="white" className="size-14">
                <path
              ...
              <span className="text-lg md:max-w-[250px] leading-tight">{p.hero.telegram.label}</span>
            </Link>
          }
        />
