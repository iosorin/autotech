        ...
        <Block
          ...
          cta={
            <Link
              ...
              className={cn("text-white shadow-sm inline-flex items-center gap-4 rounded-2xl px-5 py-4 text-sm w-fit hover:opacity-90 transition-opacity", p.hero.telegram.className)}
            >
