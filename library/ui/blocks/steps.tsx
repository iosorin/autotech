    ...
    <>
      ...
      <Enter variant="fade-up" delay={600} duration={500} >
        <div className="flex flex-wrap gap-4 justify-center mt-10">
          <Link
            href="#"
            className="inline-flex items-center gap-1 rounded-full bg-primary text-primary-foreground px-6 py-3 text-sm font-medium hover:opacity-90  transition-all duration-200"
          >
            {cabinetCta}
